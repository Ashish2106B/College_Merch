...
const products = [
  {
    ...
    name: "Premium Hoodie",
    price: 1499,
    image: "https://via.placeholder.com/500x500?text=Premium+Hoodie",
    category: "Apparel",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    name: "College Cap",
    price: 399,
    image: "https://via.placeholder.com/500x500?text=College+Cap",
  ...
  },
  {
    ...
    name: "Notebook Set",
    price: 449,
    image: "https://via.placeholder.com/500x500?text=Notebook+Set",
    category: "Stationery",
  },
  {
    id: 5,
    name: "Bottle",
    price: 699,
    image: "https://via.placeholder.com/500x500?text=Bottle",
    category: "Accessories",
  },
  {
    id: 6,
    name: "Varsity Jacket",
    price: 2499,
    image: "https://via.placeholder.com/500x500?text=Varsity+Jacket",
    category: "Apparel",
  },
];
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative hidden md:block">
              <div className="relative w-full aspect-square rounded-3xl overflow-hidden card-shadow-lg">
                <img
                  src="https://via.placeholder.com/600x600?text=College+Merchandise"
